...
`Rancher CLI`二进制文件可以直接从Rancher UI下载，下载链接可以从`Rancher UI`右下角找到。`Rancher CLI`有Windows，Mac和Linux的二进制文件。你还可以从[文件下载]({{< baseurl >}}/rancher/v2.x/cn/install-prepare/download/)页面下载最新版本的二进制文件。
