...
Rancher supports both upgrade and rollback starting with v2.0.2.  Please note the version you would like to [upgrade](https://www2.cnrancher.com/docs/rancher/v2.x/en/upgrades/) or [rollback](https://www2.cnrancher.com/docs/rancher/v2.x/en/backups/rollbacks/) to change the Rancher version.
