...
3. #### 软件
    ...
    - Docker
      ...
      > **注意：**如果您使用的是RancherOS，请确保您将Docker引擎切换为受支持的版    本`sudo ros engine switch docker-17.03.2-ce`
...
1. ### 方案A-使用默认自签名证书
    ...
    **使用默认证书安装Rancher：**
    ...
    从您的Linux主机运行Docker命令来安装Rancher，而不需要任何其他参数：
...
2. ### 方案B-使用您自己的自签名证书
    ...
    **使用自签名证书安装Rancher:**
    ...
    创建证书后，运行Docker命令安装Rancher，指向您的证书文件。
